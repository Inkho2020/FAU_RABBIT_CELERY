...
RMQ_EXCHANGE_PAINT_BUTTON = "x-paint-button-taskiq_utils"
RMQ_QUEUE_PAINT_BUTTON = "q-paint-button-taskiq_utils"
RMQ_DLX_FAILED_PAINT_BUTTON = "dlx-failed-to-paint-button-taskiq_utils"
RMQ_DLQ_FAILED_PAINT_BUTTON = "dlq-failed-to-paint-button-taskiq_utils"
RMQ_FAILED_PAINT_BUTTON_RETRY_SEC = 5_000

RMQ_QUEUE_NOT_SOLVE_TASKS = "not-solved-taskiq_utils"
